...
namespace TicTac.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITicTacDispatcher, TicDispatcher>();
            services.AddTransient<ITicTacDispatcher, TacDispatcher>();
            services.AddTransient<ITicTacDispatcher, TicTacDispatcher>();
